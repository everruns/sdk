...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        AgentVersionChangeKind: "auto" | "manual" | "patch" | "minor" | "major" | "import" | "rollback" | "fork";
         ...
         * @enum {string}
         */
        AppEndpointAuthMode: "anonymous" | "shared_secret" | "api_key" | "google_oidc" | "oidc" | "o_auth2_introspection" | "http_basic" | "mtls";
         ...
         * @enum {string}
         */
        CapabilityUsageKind: "configured" | "resolved" | "exposed" | "invoked" | "effect_ran";
        /**
         ...
         *     }
         */
        CreateMemorySourceRequest: (components["schemas"]["GitHubMemorySourceRequest"] & {
            /** @enum {string} */
            type: "github";
        ...
        /** @enum {string} */
        FindingCategory: "structure" | "completeness" | "effectiveness" | "safety" | "cost";
        /**
         ...
         * @enum {string}
         */
        McpErrorCategory: "transient" | "permanent" | "validation" | "auth" | "unknown";
        /**
         ...
         * @enum {string}
         */
        McpErrorCode: "tool_not_found" | "tool_timeout" | "tool_panicked" | "invalid_arguments" | "permission_denied" | "quota_exceeded" | "network_blocked" | "mcp_server_unreachable" | "internal" | "unknown";
        /**
        ...
        MemorySourceResponse: (components["schemas"]["ManualMemorySourceResponse"] & {
            /** @enum {string} */
            provider: "manual";
         ...
         * @enum {string}
         */
        ModelVendor: "openai" | "anthropic" | "google" | "nvidia" | "qwen" | "microsoft" | "minimax" | "moonshot" | "xai" | "llmsim";
...
export interface operations {
    ...
    list_health_checks: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["HealthCheckRun"][];
                };
            };
            /** @description Agent not found */
            404: {
    ...
    list_webhooks: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ListResponse_TaskWebhookResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    create_webhook: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateTaskWebhookRequest"];
            };
        };
        responses: {
    ...
    update_webhook: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateTaskWebhookRequest"];
            };
        };
        responses: {
