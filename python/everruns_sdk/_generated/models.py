...
#   timestamp: 2026-06-03T03:47:54+00:00
...
class GitHubVolumeSourceRequest(BaseModel):
    branch: str | None = Field(
        None,
...
class GitHubVolumeSourceResponse(BaseModel):
    branch: str
    repository: str
...
class GitVolumeSourceRequest(BaseModel):
    branch: str | None = Field(
        None,
        description="Branch to sync. Defaults to the repository's default branch when omitted.",
        examples=['main'],
...
class GitVolumeSourceResponse(BaseModel):
    branch: str
    root_folder: str | None = None
    sync_interval_secs: conint(ge=0, le=604800) | None = Field(
        None,
...
class Datum11(BaseModel):
    ...
    id: str = Field(
        ...,
        description='Prefixed public identifier. See [ID Schema](https://docs.everruns.com/advanced/id-schema/).',
        examples=['mst_01933b5a000070008000000000000001'],
    )
    is_default: bool
    name: str = Field(
        ..., description='Human-readable name. Safe to render in user-facing messages.'
...
class ManualVolumeSourceResponse(BaseModel):
    pass
...
class MemoryResponse(BaseModel):
    ...
    store_id: str = Field(..., examples=['mst_01933b5a000070008000000000000001'])
    tags: list[str] = Field(
        ..., description='Free-form tags attached to this resource.'
    )
    updated_at: AwareDatetime = Field(
...
class UpdateMemoryStoreRequest(BaseModel):
    is_default: bool | None = Field(
        None, description='Toggle this store as the org default.', examples=[True]
    )
    name: str | None = Field(
        None,
        description='Human-readable name. Safe to render in user-facing messages.',
        examples=['customer-preferences-archive'],
    )
...
class VolumeSourceResponse1(ManualVolumeSourceResponse):
    provider: Provider
...
class VolumeSourceResponse2(GitHubVolumeSourceResponse):
    provider: Provider1
...
class VolumeSourceResponse3(GitVolumeSourceResponse):
    provider: Provider2


class VolumeSourceResponse(
    RootModel[VolumeSourceResponse1 | VolumeSourceResponse2 | VolumeSourceResponse3]
):
    root: VolumeSourceResponse1 | VolumeSourceResponse2 | VolumeSourceResponse3 = Field(
...
class WithUrlsLlmProvider(BaseModel):
    ...
    status: LlmProviderStatus = Field(
...
class CreateVolumeSourceRequest1(GitHubVolumeSourceRequest):
    type: Type10


class CreateVolumeSourceRequest2(GitVolumeSourceRequest):
    type: Type11


class CreateVolumeSourceRequest(
    RootModel[CreateVolumeSourceRequest1 | CreateVolumeSourceRequest2]
):
    root: CreateVolumeSourceRequest1 | CreateVolumeSourceRequest2 = Field(
        ...,
...
class ListMemoriesResponse(BaseModel):
    data: list[MemoryResponse] = Field(
        ..., description='Page of items returned by this query.'
    )
    total: int = Field(
        ..., description='Total number of items matching the query, across all pages.'
...
class Datum18(BaseModel):
    ...
    id: str = Field(
        ...,
        description='Prefixed public identifier. See [ID Schema](https://docs.everruns.com/advanced/id-schema/).',
        examples=['vol_01933b5a000070008000000000000001'],
    )
    is_readonly: bool = Field(
        ...,
    ...
    source: VolumeSourceResponse = Field(
        ...,
...
class UpdateVolumeRequest(BaseModel):
    ...
    source: CreateVolumeSourceRequest | None = None
...
class WithUrlsSession(BaseModel):
    ...
    subagent_task: str | None = Field(
        ...
        examples=['Run the integration test suite and report failures.'],
    )
    system_prompt: str | None = Field(
        None,
