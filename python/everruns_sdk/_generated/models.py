...
#   timestamp: 2026-05-08T05:21:25+00:00
...
class CreatePaymentPolicyRequest(BaseModel):
    ...
    max_amount_usd_per_day: Optional[float] = None
    max_amount_usd_per_request: Optional[float] = None
    max_amount_usd_per_turn: Optional[float] = None
    metadata: Optional[Any] = None
...
class AgentverId(BaseModel):
    __root__: constr(regex=r'^agentver_[0-9a-f]{32}$') = Field(
        ...,
...
class EventId(BaseModel):
    __root__: constr(regex=r'^event_[0-9a-f]{32}$') = Field(
        ...,
...
class HarnessId(BaseModel):
    __root__: constr(regex=r'^harness_[0-9a-f]{32}$') = Field(
        ...,
...
class PayacctId(BaseModel):
    __root__: constr(regex=r'^payacct_[0-9a-f]{32}$') = Field(
        ...,
...
class PayattId(BaseModel):
    __root__: constr(regex=r'^payatt_[0-9a-f]{32}$') = Field(
        ...,
...
class PaypolId(BaseModel):
    __root__: constr(regex=r'^paypol_[0-9a-f]{32}$') = Field(
        ...,
...
class AgentVersion(BaseModel):
    agent_id: str = Field(..., example='agent_01933b5a000070008000000000000001')
    authored_config: Dict[str, Any]
    change_kind: AgentVersionChangeKind
    config_hash: str
    created_at: datetime
    created_by_principal_id: Optional[str] = None
    id: str = Field(..., example='agentver_01933b5a000070008000000000000001')
...
class PaymentAttempt(BaseModel):
    ...
    operation: str
    organization_id: str
    payment_account_id: Optional[PayacctId] = None
...
class PaymentPolicy(BaseModel):
    ...
    rail_preference: List[PaymentRail]
    require_approval_above_usd: Optional[float] = None
    status: PaymentStatus
    subject_id: str
    subject_type: str
...
class WithUrlsAgent(BaseModel):
    ...
    forked_from_agent_id: Optional[str] = Field(
        None,
        description='Source agent for a forked agent.',
        example='agent_01933b5a00007000800000000000001',
    )
    forked_from_version_id: Optional[str] = Field(
        None,
